...
//	Storename - 
	$value="";
		$value = ProcessLargeText(GetData($data,"Storename", ""),"","",MODE_VIEW);
	$xt->assign("Storename_value",$value);
	$xt->assign("Storename_fieldblock",true);
////////////////////////////////////////////
//	Amount - Number
	$value="";
		$value = ProcessLargeText(GetData($data,"Amount", "Number"),"","",MODE_VIEW);
	$xt->assign("Amount_value",$value);
	$xt->assign("Amount_fieldblock",true);
////////////////////////////////////////////
//	Created - Datetime
	$value="";
		$value = ProcessLargeText(GetData($data,"Created", "Datetime"),"","",MODE_VIEW);
	$xt->assign("Created_value",$value);
	$xt->assign("Created_fieldblock",true);
////////////////////////////////////////////
//	year - 
	$value="";
		$value = ProcessLargeText(GetData($data,"year", ""),"","",MODE_VIEW);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='taxitem_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='taxitem_view.php?".$prevlink."'\"");
	}
    else 
