...
$xt = new Xtempl();
$body=array();
$body["begin"]="<FORM name=frmimport id=frmimport action=\"Tax_Summary_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='Tax_Summary_list.php?a=return';\"");
$xt->assign("error_message",$error_message);
$xt->display("Tax_Summary_import.htm");
