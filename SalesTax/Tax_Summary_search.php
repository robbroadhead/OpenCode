...
"SUGGEST_TABLE = \"Tax_Summary_searchsuggest.php\";\r\n".
...
{
	document.getElementById('second_Amount').style.display =  
		document.forms.editform.elements['asearchopt_Amount'].value==\"Between\" ? '' : 'none'; 
	document.getElementById('second_monthname').style.display =  
		document.forms.editform.elements['asearchopt_monthname'].value==\"Between\" ? '' : 'none'; 
...
$jscode.="
	document.forms.editform.value_Amount.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_Amount,'advanced')};
	document.forms.editform.value1_Amount.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_Amount,'advanced1')};
	document.forms.editform.value_Amount.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_Amount,'advanced')};
	document.forms.editform.value1_Amount.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_Amount,'advanced1')};
	document.forms.editform.value_monthname.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_monthname,'advanced')};
	document.forms.editform.value1_monthname.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_monthname,'advanced1')};
	document.forms.editform.value_monthname.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_monthname,'advanced')};
	document.forms.editform.value1_monthname.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_monthname,'advanced1')};
...
{
	$opt=@$where[$strTableName."_asearchopt"]["Amount"];
	$not=@$where[$strTableName."_asearchnot"]["Amount"];
	$control_Amount["params"]["value"]=@$where[$strTableName."_asearchfor"]["Amount"];
}
$control_Amount["func"]="xt_buildeditcontrol";
$control_Amount["params"]["field"]="Amount";
$control_Amount["params"]["mode"]="search";
$xt->assignbyref("Amount_editcontrol",$control_Amount);
$control1_Amount=$control_Amount;
$control1_Amount["params"]["second"]=true;
if(@$where[$strTableName."_search"]==2)
	$control1_Amount["params"]["value"]=@$where[$strTableName."_asearchfor2"]["Amount"];
$xt->assignbyref("Amount_editcontrol1",$control1_Amount);
	
$xt->assign_section("Amount_fieldblock","<input type=\"Hidden\" name=\"asearchfield[]\" value=\"Amount\">","");
$notbox_Amount="name=\"not_Amount\"";
if($not)
	$notbox_Amount=" checked";
$xt->assign("Amount_notbox",$notbox_Amount);
...
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_Amount\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$xt->assign("searchtype_Amount",$searchtype);
//	edit format
$editformats["Amount"]="Text field";
// monthname 
$opt="";
$not=false;
$control_monthname=array();
$control_monthname["params"] = array();
if(@$where[$strTableName."_search"]==2)
{
	$opt=@$where[$strTableName."_asearchopt"]["monthname"];
	$not=@$where[$strTableName."_asearchnot"]["monthname"];
	$control_monthname["params"]["value"]=@$where[$strTableName."_asearchfor"]["monthname"];
}
$control_monthname["func"]="xt_buildeditcontrol";
$control_monthname["params"]["field"]="monthname";
$control_monthname["params"]["mode"]="search";
$xt->assignbyref("monthname_editcontrol",$control_monthname);
$control1_monthname=$control_monthname;
$control1_monthname["params"]["second"]=true;
if(@$where[$strTableName."_search"]==2)
	$control1_monthname["params"]["value"]=@$where[$strTableName."_asearchfor2"]["monthname"];
$xt->assignbyref("monthname_editcontrol1",$control1_monthname);
	
$xt->assign_section("monthname_fieldblock","<input type=\"Hidden\" name=\"asearchfield[]\" value=\"monthname\">","");
$notbox_monthname="name=\"not_monthname\"";
if($not)
	$notbox_monthname=" checked";
$xt->assign("monthname_notbox",$notbox_monthname);
...
$options.="<OPTION VALUE=\"Between\" ".(($opt=="Between")?"selected":"").">"."Between"."</option>";
$options.="<OPTION VALUE=\"Empty\" ".(($opt=="Empty")?"selected":"").">"."Empty"."</option>";
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_monthname\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$xt->assign("searchtype_monthname",$searchtype);
//	edit format
$editformats["monthname"]="Text field";
// year 
$opt="";
$not=false;
$control_year=array();
...
{
$contents_block["begin"].="action=\"Tax_Summary_list.php\" ";
}
...
$templatefile = "Tax_Summary_search.htm";
