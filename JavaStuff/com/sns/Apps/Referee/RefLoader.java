...
/**
* This class is the main program for the RefLoader application.  It uses Data,
...
public static void main (String args[]) {
  ...
  if ((args.length != 2) || (args[0].equals("-?"))) {
     ...
     System.out.println("");
     System.out.println("Example: java RefLoader data.dat refMain");
     return;
  } else {
    /* Create the database if we need to */
    theStruct = dbUtil.createRefStructure();
    try {
    ...
    try {
      ...
      dbUtil.loadRefData(theDB,args[0]);
