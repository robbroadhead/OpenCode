...
/**  Class to store integer statistics or counters with max and current
values.   
@author Rob Broadhead
@version 1.0   */
public class Capability {
   ...
   @ param mx The absolute maximum value allowed.
   */
   ...
   */
   ...
   public void AdjustCurrent(int theVal) {
      cur_A+=theVal;
      if (cur_A > full_A) {
         cur_A=full_A;
      }
   ...
   public void AdjustFull(int theVal) {
      full_A+=theVal;
      if (full_A > max_A) {
         full_A=max_A;
      }
