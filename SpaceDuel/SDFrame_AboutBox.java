...
public class SDFrame_AboutBox extends Dialog implements ActionListener {
   ...
   String product = "Space Duel Version 1.0";
   String version = "";
   String copyright = "Copyright (c) 1998";
   String comments = "A strategy game of space combat.";
   
   public SDFrame_AboutBox(Frame parent) {
      super(parent);
