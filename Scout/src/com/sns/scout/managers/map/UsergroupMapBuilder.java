...
public class UsergroupMapBuilder implements MapBuilder
{
    ...
    public static final String CLASS_NAME =
        "com.sns.scout.managers.map.UsergroupMapBuilder";
    ...
    public void doBuild() throws TorqueException
    {
        ...
        TableMap tMap = dbMap.getTable("UserGroup");
                ...
                tMap.setPrimaryKeyMethodInfo(tMap.getName());
                                      ...
                                      tMap.addForeignKey(
                "UserGroup.USERID", new Integer(0) , "Users" ,
                    "userID");
                                                        tMap.addForeignKey(
                "UserGroup.GROUPID", new Integer(0) , "Groups" ,
                    "groupID");
                              }
}
